...
image_paths = ['/home/SOB_M_DC-14-2523-40-010.png', '/home/Colab Notebooks/breakHis']
...
def get_png_files(directory):
    """
    Gets all PNG files in a Google Drive directory.

    Args:
        directory: The path to the directory.

    Returns:
        A list of paths to the PNG files.
    """
...
# Example usage:
directory = '/content/drive/MyDrive/Colab Notebooks/breakHis/BreaKHis_v1/breast/'  # Replace with your directory
png_files = get_png_files(directory)
print(png_files)
# Create a DataFrame
df = pd.DataFrame({'file_name': [os.path.basename(path) for path in png_files]})
#print(df)
df.count()

image_paths = get_png_files(directory)
print(image_paths)
...
print(image_paths)
df = extract_features(image_paths)
df.head()
